...
const Home: NextPage = () => {
  ...
  return (
    <div className=''>
      <Head>
        <title>Polygon ERC721 Nfts</title>
        <meta
          name="description"
      ...
      <main className='relative min-h-[100vh] mx-auto max-w-6xl flex flex-col items-center px-4'>
        ...
        <footer className='absolute bottom-0 flex flex-row items-center py-4 h-24'>
          <a href="https://mumbai.polygonscan.com/address/0x932ca55b9ef0b3094e8fa82435b3b4c50d713043" className='text-[#AFEEEE] hover:text-[hotpink]' target="_blank" rel="noreferrer">Contract</a>
          ...
          <span className='mx-2 text-[#AFEEEE]'>|</span>
          <a href="https://faucet.polygon.technology/" className='text-[#AFEEEE] hover:text-[hotpink]' target="_blank" rel="noreferrer">Faucet</a>
        </footer>
      </main>
    </div>
  );
